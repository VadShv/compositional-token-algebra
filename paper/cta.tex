...
rates. We position CTA against ASG, R3Mem, H-Net, and Token Merging, and argue it occupies
...
than end-to-end through the full sequence, which is cheaper but less exact. (ii) We report
an attention-FLOPs proxy; realized wall-clock throughput on accelerators, variable-length
batching, and the memory cost of the residual store remain to be measured. (iii)
